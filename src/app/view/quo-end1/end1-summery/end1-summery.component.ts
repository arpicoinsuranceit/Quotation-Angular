...
@Component({
  selector: 'app-end1-summery',
  templateUrl: './end1-summery.component.html',
  styleUrls: ['./end1-summery.component.css']
})
export class End1SummeryComponent implements OnInit {
