...
@Component({
  selector: 'app-dtap-benefict-info',
  templateUrl: './dtap-benefict-info.component.html',
  styleUrls: ['./dtap-benefict-info.component.css']
})
export class DtapBenefictInfoComponent implements OnInit {
