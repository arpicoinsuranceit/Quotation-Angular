...
@Component({
  selector: 'app-atp-personal-info',
  templateUrl: './atp-personal-info.component.html',
  styleUrls: ['./atp-personal-info.component.css']
})
export class AtpPersonalInfoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this._personalInfo._plan._hidbsa = 200000;
  ...
  loadDefault() {
    this._personalInfo._plan._bsa = 200000;
