...
@Component({
  selector: 'app-dtap-summery',
  templateUrl: './dtap-summery.component.html',
  styleUrls: ['./dtap-summery.component.css']
})
export class DtapSummeryComponent implements OnInit {
