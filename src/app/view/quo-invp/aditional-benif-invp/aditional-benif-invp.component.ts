...
import { MainLifeBenificts, SpouseBenificts, ChildrenBenificts, Benifict, HBC } from './../../../model/benificts';
...
@Component({
  selector: 'app-aditional-benif-invp',
  templateUrl: './aditional-benif-invp.component.html',
  styleUrls: ['./aditional-benif-invp.component.css']
})
