...
@Component({
  selector: 'app-sip-personal-info',
  templateUrl: './sip-personal-info.component.html',
  styleUrls: ['./sip-personal-info.component.css']
})
export class SipPersonalInfoComponent implements OnInit {
  ...
  checkBSA(){
    //let hiddenBSA=document.getElementById("txt-bsa-hidden");
