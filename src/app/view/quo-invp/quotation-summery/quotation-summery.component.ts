...
@Component({
  selector: 'app-quotation-summery',
  templateUrl: './quotation-summery.component.html',
  styleUrls: ['./quotation-summery.component.css']
})
export class QuotationSummeryComponent implements OnInit {
