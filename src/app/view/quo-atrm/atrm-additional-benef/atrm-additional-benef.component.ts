...
@Component({
  selector: 'app-atrm-additional-benef',
  templateUrl: './atrm-additional-benef.component.html',
  styleUrls: ['./atrm-additional-benef.component.css']
})
export class AtrmAdditionalBenefComponent implements OnInit {
  ...
  */
  ...
  checkValidateCIB() {
    ...
    if (this.validateCIB == 1) {
      ...
      swal("Error!", "CIB must be greater than or equal 250,000 and less than or equal 6,000,000 and less than sum of ATPB and BSA and CIB mod 25,000 must be equal to 0", "error");
    }
