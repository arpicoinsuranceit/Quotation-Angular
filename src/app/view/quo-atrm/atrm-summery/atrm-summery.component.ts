...
@Component({
  selector: 'app-atrm-summery',
  templateUrl: './atrm-summery.component.html',
  styleUrls: ['./atrm-summery.component.css']
})
export class AtrmSummeryComponent implements OnInit {
