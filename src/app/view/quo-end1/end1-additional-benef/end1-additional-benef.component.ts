...
@Component({
  selector: 'app-end1-additional-benef',
  templateUrl: './end1-additional-benef.component.html',
  styleUrls: ['./end1-additional-benef.component.css']
})
export class End1AdditionalBenefComponent implements OnInit {
...
*/
  ...
  checkValidateFEB() {
    ...
    this.validateFEB = this.benefitsValidations.validateFEBEND(rBSA, bSA);
  ...
  checkValidateFEBS() {
    ...
    this.validateFEBS = this.benefitsValidations.validateFEBSEND(rBSA, bSA);

    if (this.validateFEBS == 1) {
    } else {
      swal("Error!", "FEBS must be greater than or equal 10,000 and less than or equal 75,000 and less than or equal 10% of BSA", "error");
    }
    this.allForms.abmForm = this.abmForm; this.allForms.absForm = this.absForm; this.allForms.abcForm = this.abcForm; this.onsetBenifAll("", "");
  }
