...
@Component({
  selector: 'app-asfp-summery',
  templateUrl: './asfp-summery.component.html',
  styleUrls: ['./asfp-summery.component.css']
})
export class AsfpSummeryComponent implements OnInit {
