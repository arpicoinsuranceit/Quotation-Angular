...
@Component({
  ...
  templateUrl: './arp-additional-benef.component.html',
  styleUrls: ['./arp-additional-benef.component.css']
})
export class ArpAdditionalBenefComponent implements OnInit {
  ...
  checkValidateCIBC() {
    ...
    if (this.validateCIBC == 1) {
      ...
      swal("Error!", "CIBC must be greater than or equal 250,000 and less than or equal 1,000,000 and less than sum of ATPB and BSA and CIBC mod 25,000 must be equal to 0", "error");
    }
    //} else {
    //swal("ATPB Required!", "Can't get this benefict without getting ATPB..!", "warning");
    //}
