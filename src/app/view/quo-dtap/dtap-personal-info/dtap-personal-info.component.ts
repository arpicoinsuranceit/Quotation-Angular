...
@Component({
  selector: 'app-dtap-personal-info',
  templateUrl: './dtap-personal-info.component.html',
  styleUrls: ['./dtap-personal-info.component.css']
})
export class DtapPersonalInfoComponent implements OnInit {
