...
@Component({
  ...
  templateUrl: './quo-end1.component.html',
  styleUrls: ['./quo-end1.component.css']
})
export class QuoEnd1Component implements OnInit {
  ...
  @ViewChild(End1PersonalInfoComponent) end1PersonalInfoComponent: End1PersonalInfoComponent;
