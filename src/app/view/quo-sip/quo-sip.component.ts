...
@Component({
  selector: 'app-quo-sip',
  templateUrl: './quo-sip.component.html',
  styleUrls: ['./quo-sip.component.css']
})
export class QuoSipComponent implements OnInit {
  ...
  @ViewChild(SipPersonalInfoComponent) sipPersonolInfoComponent: SipPersonalInfoComponent;
  @ViewChild(SipAdditionalBenefComponent) sipBenefictInfoComponent: SipAdditionalBenefComponent;
          ...
          if (this.personalInfo._mainlife._mOccupation != "285") {
            if (this.activeSp == "1") {
              if (this.personalInfo._spouse._sOccupation != "285") {
                ...
                this.isDisableDiv = true;
                document.onkeydown = function (e) { return false; }
                this.saveAsipQuotationService.saveAsip(this._invpSaveQuotation).subscribe(response => {
                  this.isDisableDiv = false;
                  document.onkeydown = function (e) { return true; }
  ...
  clearquo() {
    this.sipBenefictInfoComponent.loadDefault();
    this.sipPersonolInfoComponent.loadDefault();
    this.sendQuo();
  }
  ...
  clearbenef(e) {
    ...
    this.sipBenefictInfoComponent.loadDefaultNew();
    //this.sendQuo();
  }

  clearbenefAll(e) {

    this.sipBenefictInfoComponent.loadDefaultBSAChange();
    //this.sendQuo();
  }
